...
import { Icon, Image, Options, Quote, SideBar } from './styles'
  ...
  return (
    <>
      ...
      <SideBar>
        ...
        <Quote family={mockQupte.language === 'Chinese' ? 'Ma Shan Zheng' : 'Noto Serif JP'} size={mockQupte.language === 'Chinese' ? '1.8rem' : '1.45rem'}>{mockQupte.sentence}</Quote>
