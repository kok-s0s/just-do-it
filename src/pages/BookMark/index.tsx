...
const SortableItem = SortableElement(
  (props: { shouldUseDragHandle?: any; value?: any }) => {
...
export default function BookMark() {
  ...
  useEffect(() => {
    const getData = async () => {
      ...
      if (
        resList.status === 200 &&
        resCategory.status === 200 &&
        resList.data.length > bookmarkList.length
      ) {
          ...
          <False>
            ...
            >
              <g fill="currentColor">
                ...
                <path
                  fillRule="evenodd"
                  d="M24 4c11.046 0 20 8.954 20 20s-8.954 20-20 20S4 35.046 4 24S12.954 4 24 4Zm18.095 20c0-9.994-8.101-18.095-18.095-18.095c-9.994 0-18.095 8.101-18.095 18.095c0 9.994 8.101 18.095 18.095 18.095c9.994 0 18.095-8.101 18.095-18.095Z"
                  clipRule="evenodd"
                />
              </g>
            </svg>
