  ...
  return (
    <>
      <Modal open={open} onClose={handleClose} aria-labelledby="modal-modal-title" aria-describedby="modal-modal-description">
        <Box sx={style}>
          <TextField label="username" variant="standard" required value={name} onChange={e => setName(e.target.value)} />
      ...
      <InfoScreen>
        <GithubInfo>
          {info.avatar_url ? <GithubInfoImage src={info.avatar_url} alt="avatar" /> : <Skeleton variant="circular" width={200} height={200} />}
